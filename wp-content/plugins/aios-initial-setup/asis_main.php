...
// Define paths
if(! defined('AIOS_INITIAL_SETUP_VERSION')) define('AIOS_INITIAL_SETUP_VERSION', '5.5.1');
...
if(! defined('AIOS_ASSETS_MINIFIER')) define('AIOS_ASSETS_MINIFIER', 'https://api.agentimage.com/');
